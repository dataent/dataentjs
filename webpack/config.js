...
const dataentDependencies = require('../package.json').dependencies;
...
function makeConfig() {
  ...
  const allDependencies = Object.assign(dataentDependencies, appDependencies);
      ...
      plugins: [
        ...
        new FriendlyErrorsWebpackPlugin({
          compilationSuccessInfo: {
            messages: [`dataentJS server started at http://${appConfig.dev.devServerHost}:${appConfig.dev.devServerPort}`],
          },
        }),
